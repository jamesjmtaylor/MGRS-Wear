...
public class Position extends LatLon
{
        ...
        Iterable<? extends Position> positions)
    {
        ...
        {
            Angle distance = greatCircleDistance(oldPosition, pos);
            Angle azimuth = greatCircleAzimuth(oldPosition, pos);
            LatLon newLocation = greatCircleEndPosition(newPosition, azimuth, distance);
