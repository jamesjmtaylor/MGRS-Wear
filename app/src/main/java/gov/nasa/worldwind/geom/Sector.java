...
public class Sector implements Comparable<Sector>, Iterable<LatLon>
{
    ...
    /**
     * Creates a new <code>Sector</code> and initializes it to the angles resulting from the given in degrees lat-lon coordinates where x corresponds to longitude and y to latitude. The
    ...
    {
        return fromDegrees(rectangle.y, rectangle.y + rectangle.height, rectangle.x, rectangle.width + rectangle.x);
    }
